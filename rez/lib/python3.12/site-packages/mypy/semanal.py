...
from mypy.nodes import (ARG_NAMED, ARG_POS, CONTRAVARIANT, COVARIANT, GDEF,
                        IMPLICITLY_ABSTRACT, INVARIANT, IS_ABSTRACT, LDEF,
                        MDEF, REVEAL_LOCALS, REVEAL_TYPE,
                        ...
                        TypeVarLikeExpr, TypeVarTupleExpr, UnaryExpr, Var,
...
from mypy.typeanal import (TypeAnalyser, TypeVarLikeList, TypeVarLikeQuery,
                           ...
                           detect_diverging_alias, fix_instance_types,
...
from mypy.types import (ASSERT_TYPE_NAMES, FINAL_DECORATOR_NAMES,
                        ...
                        TYPE_ALIAS_NAMES, TYPED_NAMEDTUPLE_NAMES, AnyType,
                        CallableType, FunctionLike, Instance, LiteralType,
                        LiteralValue, NoneType, Overloaded, Parameters,
                        ParamSpecType, PlaceholderType, ProperType, StarType,
                        TrivialSyntheticTypeTranslator, TupleType, Type,
                        TypeAliasType, TypedDictType, TypeOfAny, TypeType,
                        TypeVarLikeType, TypeVarType, UnboundType, UnpackType,
                        get_proper_type, get_proper_types,
                        invalid_recursive_alias, is_named_instance)
...
class SemanticAnalyzer(
    ...
    def analyze_metaclass(self, defn: ClassDef) -> None:
        if defn.metaclass:
            ...
            if metaclass_name is None:
                self.fail(
                    f'Dynamic metaclass not supported for "{defn.name}"', defn.metaclass
                )
                return
    ...
    def in_checked_function(self) -> bool:
        ...
        while current_index >= 0:
            ...
            if isinstance(current_func, FuncItem) and not isinstance(
                current_func, LambdaExpr
            ):
