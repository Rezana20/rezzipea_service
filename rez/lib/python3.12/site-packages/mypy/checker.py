...
from typing import (AbstractSet, Any, Callable, Dict, Generic, Iterable,
                    Iterator, Mapping, NamedTuple, Optional, Sequence, Tuple,
...
from mypy.messages import (SUGGESTED_TEST_FIXTURES, MessageBuilder,
                           append_invariance_notes, format_type,
                           format_type_bare, format_type_distinctly,
                           make_inferred_type_note, pretty_seq)
from mypy.mro import MroError, calculate_mro
from mypy.nodes import (ARG_NAMED, ARG_POS, ARG_STAR, CONTRAVARIANT, COVARIANT,
                        GDEF, IMPLICITLY_ABSTRACT, INVARIANT, IS_ABSTRACT,
                        LDEF, LITERAL_TYPE, MDEF, AssertStmt, AssignmentExpr,
                        AssignmentStmt, Block, BreakStmt, CallExpr, ClassDef,
                        ComparisonExpr, Context, ContinueStmt, Decorator,
                        DelStmt, EllipsisExpr, Expression, ExpressionStmt,
                        ForStmt, FuncBase, FuncDef, FuncItem, IfStmt, Import,
                        ImportAll, ImportBase, ImportFrom, IndexExpr, IntExpr,
                        LambdaExpr, ListExpr, Lvalue, MatchStmt, MemberExpr,
                        MypyFile, NameExpr, Node, OperatorAssignmentStmt,
                        ...
                        TupleExpr, TypeAlias, TypeInfo, TypeVarExpr, UnaryExpr,
                        Var, WhileStmt, WithStmt, is_final_node)
...
from mypy.subtypes import (find_member, is_callable_compatible, is_equivalent,
...
from mypy.typeops import (bind_self, coerce_to_literal, custom_special_method,
                          ...
                          erase_to_union_or_bound, false_only, function_type,
                          get_type_vars, is_literal_type_like,
                          is_singleton_type, make_simplified_union,
                          map_type_from_supertype, true_only,
                          try_expanding_sum_type_to_union,
                          try_getting_int_literals_from_type,
                          try_getting_str_literals_from_type, tuple_fallback)
from mypy.types import (OVERLOAD_NAMES, AnyType, CallableType, DeletedType,
                        FunctionLike, Instance, LiteralType, NoneType,
                        Overloaded, ParamSpecType, PartialType, ProperType,
                        StarType, TupleType, Type, TypeAliasType,
                        TypedDictType, TypeGuardedType, TypeOfAny, TypeQuery,
                        TypeTranslator, TypeType, TypeVarId, TypeVarType,
                        UnboundType, UninhabitedType, UnionType,
                        flatten_nested_unions, get_proper_type,
                        get_proper_types, is_literal_type, is_named_instance,
                        is_optional, remove_optional, strip_type)
...
class TypeChecker(NodeVisitor[None], CheckerPluginInterface):
    ...
    def check_func_def(
        self, defn: FuncItem, typ: CallableType, name: str | None
    ) -> None:
        """Type check a function definition."""
