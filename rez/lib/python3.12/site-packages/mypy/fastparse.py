...
from mypy.nodes import (ARG_NAMED, ARG_NAMED_OPT, ARG_OPT, ARG_POS, ARG_STAR,
                        ARG_STAR2, ArgKind, Argument, AssertStmt,
                        ...
                        ExpressionStmt, FakeInfo, FloatExpr, ForStmt, FuncDef,
                        ...
                        TupleExpr, UnaryExpr, Var, WhileStmt, WithStmt,
                        YieldExpr, YieldFromExpr, check_arg_names)
...
from mypy.types import (AnyType, CallableArgument, CallableType, EllipsisType,
                        ...
                        Type, TypeList, TypeOfAny, UnboundType, UnionType)
...
try:
    ...
    if sys.version_info >= (3, 8):
        ...
        from ast import (FunctionType, Index, Name, NameConstant, Num, Starred,
                         Str, UnaryOp, USub)
        ...
        from typed_ast.ast3 import (FunctionType, Index, Name, NameConstant,
                                    Num, Starred, Str, UnaryOp, USub)
