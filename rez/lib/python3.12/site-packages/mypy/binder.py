...
from mypy.nodes import (AssignmentExpr, Expression, IndexExpr, MemberExpr,
                        NameExpr, RefExpr, Var)
from mypy.subtypes import is_same_type, is_subtype
from mypy.types import (AnyType, NoneType, PartialType, Type, TypeOfAny,
