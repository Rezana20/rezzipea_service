...
from mypy.types import (TUPLE_LIKE_INSTANCE_NAMES, AnyType, CallableType,
                        ...
                        TypeQuery, TypeType, TypeVarId, TypeVarTupleType,
                        TypeVarType, TypeVisitor, UnboundType, UninhabitedType,
                        UnionType, UnpackType, callable_with_ellipsis,
                        get_proper_type, has_recursive_types, has_type_vars,
                        is_named_instance, is_union_with_any)
from mypy.typestate import TypeState
from mypy.typevartuples import (extract_unpack, find_unpack_in_list,
                                split_with_instance,
                ...
                for tvar, mapped_arg, template_arg in zip(
                    ...
                    if isinstance(tvar, TypeVarType):
                        ...
                        if isinstance(suffix, Parameters) or isinstance(
                            ...
                            res.append(
                                Constraint(template_arg.id, SUPERTYPE_OF, suffix)
                            )
                        elif isinstance(suffix, ParamSpecType):
                            res.append(
                                Constraint(template_arg.id, SUPERTYPE_OF, suffix)
