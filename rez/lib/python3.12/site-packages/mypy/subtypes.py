...
from mypy.nodes import (ARG_STAR, ARG_STAR2, CONTRAVARIANT, COVARIANT,
                        Decorator, FuncBase, OverloadedFuncDef, TypeInfo, Var)
from mypy.options import Options
from mypy.state import state
from mypy.types import (TUPLE_LIKE_INSTANCE_NAMES, TYPED_NAMEDTUPLE_NAMES,
                        ...
                        TypeOfAny, TypeType, TypeVarTupleType, TypeVarType,
                        TypeVisitor, UnboundType, UninhabitedType, UnionType,
                        UnpackType, get_proper_type, is_named_instance)
        ...
        if isinstance(right, Instance):
            ...
            if (
                ...
                if right.type.has_type_var_tuple_type:
                    ...
                    right_prefix, right_middle, right_suffix = split_with_instance(
                        right
                    )
