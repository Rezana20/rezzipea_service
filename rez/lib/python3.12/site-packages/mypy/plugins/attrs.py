...
from mypy.nodes import (ARG_NAMED, ARG_NAMED_OPT, ARG_OPT, ARG_POS, MDEF,
                        ...
                        Expression, FuncDef, JsonDict, LambdaExpr, ListExpr,
                        MemberExpr, NameExpr, OverloadedFuncDef,
                        PlaceholderNode, RefExpr, SymbolTableNode, TempNode,
                        TupleExpr, TypeInfo, TypeVarExpr, Var, is_class_var)
...
from mypy.types import (AnyType, CallableType, FunctionLike, Instance,
                        LiteralType, NoneType, Overloaded, TupleType, Type,
                        TypeOfAny, TypeVarType, UnionType, get_proper_type)
...
def _add_attrs_magic_attribute(
    ...
    var = Var(
        name=MAGIC_ATTR_NAME, type=TupleType(attributes_types, fallback=attributes_type)
    )
    var.info = ctx.cls.info
