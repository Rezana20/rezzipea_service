...
from mypy.nodes import (ARG_NAMED, ARG_POS, ARG_STAR, ARG_STAR2,
                        IMPLICITLY_ABSTRACT, LITERAL_TYPE, REVEAL_TYPE,
                        ArgKind, AssertTypeExpr, AssignmentExpr, AwaitExpr,
                        BytesExpr, CallExpr, CastExpr, ComparisonExpr,
                        ComplexExpr, ConditionalExpr, Context, Decorator,
                        DictExpr, DictionaryComprehension, EllipsisExpr,
                        EnumCallExpr, Expression, FloatExpr, FuncDef,
...
from mypy.subtypes import (is_equivalent, is_same_type, is_subtype,
                           non_method_protocol_members)
from mypy.traverser import has_await_expression
from mypy.typeanal import (check_for_explicit_any, expand_type_alias,
...
from mypy.types import (LITERAL_TYPE_NAMES, TUPLE_LIKE_INSTANCE_NAMES, AnyType,
                        CallableType, DeletedType, ErasedType, FunctionLike,
                        Instance, LiteralType, LiteralValue, NoneType,
                        Overloaded, ParamSpecFlavor, ParamSpecType,
                        PartialType, ProperType, StarType, TupleType, Type,
                        TypedDictType, TypeOfAny, TypeType, TypeVarType,
                        UninhabitedType, UnionType, flatten_nested_unions,
                        get_proper_type, get_proper_types, has_recursive_types,
                        is_generic_instance, is_named_instance, is_optional,
                        remove_optional)
    ...
    def check_boolean_op(self, e: OpExpr, context: Context) -> Type:
        ...
        if e.right_always:
            left_map, right_map = (
                None,
                {},
            )  # type: mypy.checker.TypeMap, mypy.checker.TypeMap
