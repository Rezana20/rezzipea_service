...
from typing import (TYPE_CHECKING, Any, ClassVar, Dict, Iterable, NamedTuple,
                    NewType, Sequence, TypeVar, Union, cast)
...
class CallableType(FunctionLike):
    ...
    def with_unpacked_kwargs(self) -> NormalizedCallableType:
        ...
        assert isinstance(last_type, ProperType) and isinstance(
            last_type, TypedDictType
        )
        extra_kinds = [
            ArgKind.ARG_NAMED
...
from mypy.type_visitor import \
    SyntheticTypeVisitor as SyntheticTypeVisitor  # noqa: F811
