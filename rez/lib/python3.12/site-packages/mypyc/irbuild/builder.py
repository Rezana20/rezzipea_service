...
from mypy.nodes import (ARG_NAMED, ARG_POS, GDEF, LDEF, ArgKind, CallExpr,
                        ...
                        SymbolNode, TupleExpr, TypeInfo, UnaryExpr, Var)
from mypy.types import (Instance, TupleType, Type, UninhabitedType,
                        get_proper_type)
...
from mypyc.ir.ops import (NAMESPACE_MODULE, Assign, BasicBlock, Branch,
                          GetAttr, InitStatic, Integer, LoadStatic, Op,
                          RaiseStandardError, Register, SetAttr, TupleGet,
                          Unreachable, Value)
from mypyc.ir.rtypes import (RInstance, RTuple, RType, c_int_rprimitive,
                             c_pyssize_t_rprimitive, dict_rprimitive,
                             int_rprimitive, is_list_rprimitive,
                             is_none_rprimitive, is_object_rprimitive,
                             is_tuple_rprimitive, none_rprimitive,
...
from mypyc.primitives.misc_ops import (check_unpack_count_op,
                                       get_module_dict_op,
                                       import_extra_args_op, import_op)
