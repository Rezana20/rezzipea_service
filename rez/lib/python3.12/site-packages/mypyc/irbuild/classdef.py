...
from mypy.nodes import (AssignmentStmt, CallExpr, ClassDef, Decorator,
                        ExpressionStmt, FuncDef, Lvalue, MemberExpr, NameExpr,
                        OverloadedFuncDef, PassStmt, RefExpr, StrExpr,
                        TempNode, TypeInfo, is_class_var)
...
from mypyc.irbuild.function import (handle_ext_method, handle_non_ext_method,
                                    load_type)
