...
from mypyc.ir.ops import (Assign, AssignMulti, BasicBlock, Box, Branch, Call,
                          CallC, Cast, ComparisonOp, DecRef, Extend, GetAttr,
                          GetElementPtr, Goto, IncRef, Integer, IntOp,
                          LoadAddress, LoadMem, Op, Register, Return, SetAttr,
                          SetMem, TupleGet, Unbox, Unreachable, Value)
