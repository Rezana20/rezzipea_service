...
from mypyc.ir.rtypes import (RType, bit_rprimitive, bool_rprimitive,
                             ...
                             int_rprimitive, object_rprimitive, str_rprimitive,
                             void_rtype)
from mypyc.primitives.registry import (CFunctionDescription, binary_op,
                                       custom_op, function_op, load_address_op,
                                       unary_op)
